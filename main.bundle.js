...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__myFilter__ = __webpack_require__("../../../../../src/app/myFilter.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__mainbar_mainbar_component__ = __webpack_require__("../../../../../src/app/mainbar/mainbar.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__mainbar2_mainbar2_component__ = __webpack_require__("../../../../../src/app/mainbar2/mainbar2.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__applyloan_applyloan_component__ = __webpack_require__("../../../../../src/app/applyloan/applyloan.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__loanslider_loanslider_component__ = __webpack_require__("../../../../../src/app/loanslider/loanslider.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["K" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_15__mainbar_mainbar_component__["a" /* MainbarComponent */],
                ...
                __WEBPACK_IMPORTED_MODULE_16__mainbar2_mainbar2_component__["a" /* Mainbar2Component */],
                __WEBPACK_IMPORTED_MODULE_17__applyloan_applyloan_component__["a" /* ApplyloanComponent */],
                __WEBPACK_IMPORTED_MODULE_18__loanslider_loanslider_component__["a" /* LoansliderComponent */],
                __WEBPACK_IMPORTED_MODULE_12__myFilter__["a" /* MyFilterPipe */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_14__angular_material__["x" /* MatSliderModule */],
                __WEBPACK_IMPORTED_MODULE_14__angular_material__["w" /* MatSlideToggleModule */],
                ...
                __WEBPACK_IMPORTED_MODULE_14__angular_material__["B" /* MatTableModule */],
                __WEBPACK_IMPORTED_MODULE_14__angular_material__["C" /* MatTabsModule */],
                __WEBPACK_IMPORTED_MODULE_14__angular_material__["D" /* MatToolbarModule */],
                __WEBPACK_IMPORTED_MODULE_14__angular_material__["E" /* MatTooltipModule */],
                __WEBPACK_IMPORTED_MODULE_14__angular_material__["A" /* MatStepperModule */],
...
// import { NewroleComponent } from './userrole/newrole.component';
...
var ApplyloanComponent = (function () {
    ...
    ApplyloanComponent.prototype.OnfileSelcted = function (event) {
        console.log(event);
        var file = event.target.files[0];
        alert(this.selectedfile.name);
    };
    ApplyloanComponent.prototype.Onfileupload = function () {
        var fd = new FormData();
    };
    // return this.services.getloantypes().subscribe(lntypes => console.log(lntypes));
    ApplyloanComponent.prototype.filtercity = function () {
        alert(this.customer.personalinfo.state);
    };
...
module.exports = "<div *ngIf=\"btnNewCustomerInfo==true\">\n\n  <mat-horizontal-stepper [linear]=\"isLinear\" [(selectedIndex)]=\"currentstep\" class=\"w3-small w3-text-grey\">\n    <mat-step [stepControl]=\"firstFormGroup\">\n     <!-- <ng-template matStepLabel >Personal Details</ng-template> -->\n     <h3>Personal Details </h3>\n       <div class=\"main main-raised  w3-small\">\n\n       <table style=\"width:70%\" >\n          <tr>\n          <td>\n          <mat-form-field class=\"half-full-width\">\n<mat-select placeholder=\"Choose Title\" [(ngModel)]=\"customer.personalinfo.title\">\n<mat-option value=\"Mr\">Mr</mat-option>\n<mat-option value=\"Mrs\">Mrs</mat-option>\n<mat-option value=\"Miss\">Miss</mat-option>\n<mat-option value=\"Chief\">Chief</mat-option>\n<mat-option value=\"Prof\">Prof</mat-option>\n<mat-option value=\"Pastor\">Pastor</mat-option>\n<mat-option value=\"Alhaji\">Alhaji</mat-option>\n<mat-option value=\"Alhaja\">Alhaja</mat-option>\n</mat-select>\n</mat-form-field>\n\n          </td>\n          <td class=\"td-space2\"></td>\n          <td>\n              <mat-form-field class=\"half-full-width\">\n              <input matInput placeholder=\"Surname\" [(ngModel)]=\"customer.personalinfo.surname\">\n            </mat-form-field>\n          </td>\n          <td>\n\n              </td>\n\n          </tr>\n          <tr>\n            <td>\n                <mat-form-field class=\"half-full-width\">\n                    <input matInput placeholder=\"First Name\" [(ngModel)]=\"customer.personalinfo.lastname\">\n                  </mat-form-field>\n            </td>\n            <td class=\"td-space2\"></td>\n            <td>\n                  <mat-form-field class=\"half-full-width\">\n                    <input matInput placeholder=\"Middle Name\">\n                  </mat-form-field>\n            </td>\n            </tr>\n            <tr>\n                <td>\n       <label class=\"w3-small w3-text-grey\" >Sex:</label>\n       <br>\n      <mat-radio-group  class=\"w3-small w3-text-grey\" [(ngModel)]=\"customer.personalinfo.sex\" >\n      <mat-radio-button value=\"male\" >Male </mat-radio-button>\n      <mat-radio-button value=\"female\" >Female </mat-radio-button>\n      </mat-radio-group>\n       </td>\n                <td class=\"td-space\"></td>\n                <td>\n                  <mat-form-field class=\"half-full-width\">\n                    <mat-select placeholder=\"Marital Status\"  [(ngModel)]=\"customer.personalinfo.maritstatus\" >\n                  <mat-option value=\"single\">Single </mat-option>\n                  <mat-option value=\"married\">Married</mat-option>\n                  <mat-option value=\"divorced\">Divorced</mat-option>\n                </mat-select>\n                  </mat-form-field>\n                </td>\n                </tr>\n                <tr>\n                    <td>\n                        <mat-form-field class=\"half-full-width\" >\n                            <input matInput   [matDatepicker]=\"picker\" placeholder=\"Date of Birth\" [(ngModel)]=\"customer.personalinfo.birthdate\">\n                            <mat-datepicker-toggle matSuffix [for]=\"picker\"></mat-datepicker-toggle>\n                            <mat-datepicker #picker></mat-datepicker>\n                          </mat-form-field>\n                    </td>\n                    <td class=\"td-space\"></td>\n                    <td>\n\n                      <mat-form-field class=\"half-full-width\">\n                        <mat-select placeholder=\"Means of Identification\" [(ngModel)]=\"customer.personalinfo.meandofid\">\n                        <mat-option value=\"workid\">Work ID</mat-option>\n                        <mat-option value=\"intlpassport\">Int; Passport</mat-option>\n                        <mat-option value=\"driverlicense\">Driver License</mat-option>\n                        <mat-option value=\"nationalid\">National ID</mat-option>\n                        </mat-select>\n                      </mat-form-field>\n                    </td>\n                    </tr>\n          <tr>\n          <td>\n            <mat-form-field class=\"half-full-width\">\n                <input matInput placeholder=\"Mobile No\" [(ngModel)]=\"customer.personalinfo.mobileno\">\n              </mat-form-field>\n          </td>\n          <td class=\"td-space\"></td>\n          <td>\n\n              <mat-form-field class=\"half-full-width\">\n                  <input matInput placeholder=\"Personal E-mail\" [(ngModel)]=\"customer.personalinfo.personalemail\">\n                </mat-form-field>\n          </td>\n          </tr>\n\n          <tr>\n              <td>\n\n                <mat-form-field class=\"half-full-width\">\n                    <input matInput placeholder=\"Residential Address\" [(ngModel)]=\"customer.personalinfo.address\">\n                  </mat-form-field>\n              </td>\n              <td class=\"td-space2\"></td>\n              <td>\n              <mat-form-field class=\"half-full-width\">\n                <mat-select placeholder=\"State\" [(ngModel)]=\"customer.personalinfo.state\" (Change)=\"filtercity()\" >\n\n                  <mat-option *ngFor=\" let lstate of nigeriastates\" value = {{lstate.stateid}} >{{lstate.statename}}</mat-option>\n                </mat-select>\n                </mat-form-field>\n\n              </td>\n              </tr>\n              <tr>\n                  <td>\n                    <mat-form-field class=\"half-full-width\">\n                    <mat-select placeholder=\"City\" [(ngModel)]=\"customer.personalinfo.city\">\n                        <mat-option *ngFor=\" let city of statecities  \" value={{city.cityid}}>{{city.cityname}}</mat-option>\n                      </mat-select>\n                </mat-form-field>\n                  </td>\n                  <td class=\"td-space2\"></td>\n                  <td>\n                    <button mat-button matStepperNext>Next</button>\n                 </td>\n\n                  </tr>\n          </table>\n          </div>\n\n         </mat-step>\n    <mat-step [stepControl]=\"secondFormGroup\">\n             <!-- <ng-template matStepLabel>Employment and Next of Kin</ng-template> -->\n             <h3>Employment and Next of Kin</h3>\n             <div class=\"main main-raised  w3-small\">\n               <table  style=\"width:70%\">\n                 <tr >\n                    <td>\n                     <mat-form-field  class=\"full-width\">\n                     <input matInput placeholder=\"Present Employer\" >\n                   </mat-form-field>\n                  </td>\n                   <td class=\"td-space2\"></td>\n            <td>\n<mat-form-field class=\"half-full-width\">\n<input matInput placeholder=\"Address\">\n</mat-form-field>\n                </td>\n                  </tr>\n                 <tr>\n                   <td>\n                       <mat-form-field class=\"full-width\">\n                           <input matInput placeholder=\"Position at work\">\n                         </mat-form-field>\n                   </td>\n                   <td class=\"td-space2\"></td>\n                    <td>\n                        <mat-form-field class=\"half-full-width\">\n                          <input matInput placeholder=\"Department\">\n                       </mat-form-field>\n                    </td>\n                  </tr>\n                  <tr>\n                    <td>\n                        <mat-form-field class=\"full-width\">\n                            <input matInput placeholder=\"Official E-mail\">\n                          </mat-form-field>\n                       </td>\n                       <td class=\"td-space2\"></td>\n                            <td>\n                            <mat-form-field class=\"half-full-width\">\n                                <input matInput placeholder=\"Telephone (Office)\">\n                              </mat-form-field>\n\n                           </td>\n                           </tr>\n                 </table>\n                 <div class=\"w3-container w3-black\">\n                 <h6> Next of Kin </h6>\n                </div>\n                 <table style=\"width:70%\">\n                    <tr>\n                    <td>\n                    <mat-form-field class=\"full-width\" >\n           <mat-select placeholder=\"Choose Title\">\n           <mat-option value=\"Mr\">Mr</mat-option>\n           <mat-option value=\"Mrs\">Mrs</mat-option>\n           <mat-option value=\"Miss\">Miss</mat-option>\n           <mat-option value=\"Chief\">Chief</mat-option>\n           <mat-option value=\"Prof\">Prof</mat-option>\n           <mat-option value=\"Pastor\">Pastor</mat-option>\n           <mat-option value=\"Alhaji\">Alhaji</mat-option>\n           <mat-option value=\"Alhaja\">Alhaja</mat-option>\n           </mat-select>\n           </mat-form-field>\n                    </td>\n                    <td class=\"td-space2\"></td>\n                    <td>\n                        <mat-form-field class=\"half-full-width\">\n                        <input matInput placeholder=\"Surname\">\n                      </mat-form-field>\n                    </td>\n                    </tr>\n                    <tr>\n                      <td>\n                          <mat-form-field class=\"full-width\">\n                              <input matInput placeholder=\"Other Name\">\n                            </mat-form-field>\n                      </td>\n                      <td class=\"td-space2\"></td>\n                      <td>\n                       <label class=\"w3-small w3-text-grey\" >Sex:</label>\n                      <mat-radio-group  class=\"w3-small w3-text-grey\"  >\n                      <mat-radio-button value=\"male\" >Male </mat-radio-button>\n                      <mat-radio-button value=\"female\" >Female </mat-radio-button>\n                      </mat-radio-group>\n                      </td>\n                      </tr>\n                      <tr>\n                          <td>\n                             <mat-form-field class=\"full-width\">\n                                 <input matInput placeholder=\"Telephone (Home)\">\n                               </mat-form-field>\n                         </td>\n                         <td class=\"td-space2\"></td>\n                             <td>\n                               <mat-form-field class=\"half-full-width\">\n                                   <input matInput placeholder=\"Mobile No\">\n                                 </mat-form-field>\n                          </td>\n                          </tr>\n\n                          <tr>\n                              <td>\n                                 <mat-form-field class=\"full-width\">\n                                     <input matInput placeholder=\"Residential Address (No P.O. Box)\">\n                                   </mat-form-field>\n                              </td>\n                              </tr>\n                           <tr>\n                            <td>\n\n                                <mat-form-field class=\"full-width\">\n                                    <mat-select placeholder=\"State\">\n                                      <mat-option *ngFor=\" let lstate of nigeriastates\" value={{lstate.stateid}}>{{lstate.statename}}</mat-option>\n                                    </mat-select>\n                                    </mat-form-field>\n                            </td>\n                            <td class=\"td-space2\"></td>\n                            <td>\n                                <mat-form-field class=\"half-full-width\">\n                                    <input matInput placeholder=\"City\">\n                                  </mat-form-field>\n\n                            </td>\n\n                            </tr>\n                    </table>\n                 </div>\n\n         <div>\n          <button mat-button matStepperPrevious>Back</button>\n          <button mat-button matStepperNext>Next</button>\n        </div>\n    </mat-step>\n<mat-step [stepControl]=\"forthFormGroup\">\n<!-- <ng-template matStepLabel>Loan and Bank Details</ng-template> -->\n<div class=\"main main-raised  w3-small\">\n  <h3>Loan and Bank Details </h3>\n\n                       <table style=\"width:70%\">\n                         <tr >\n                            <td>\n                             <mat-form-field class=\"half-full-width\">\n                             <input matInput placeholder=\"Loan Amount\" >\n                           </mat-form-field>\n                        </td>\n                           <td class=\"td-space2\"></td>\n                           <td>\n                               <mat-form-field class=\"full-width\">\n                                   <input matInput type=\"number\" placeholder=\"Tenor in Months\">\n                                 </mat-form-field>\n                           </td>\n                           </tr>\n                           <tr>\n                               <td>\n                                <mat-form-field class=\"half-full-width\">\n                                  <input matInput placeholder=\"Amount in words\">\n                                </mat-form-field>\n                            </td>\n                            <td class=\"td-space2\"></td>\n                                   <td>\n                                    <mat-form-field class=\"full-width\">\n                                      <mat-select placeholder=\"Loan Purpose\">\n                                      <mat-option *ngFor=\" let loantype of loantypes\" value={{loantype.loantypeid}}>{{loantype.loandesc}}</mat-option>\n                                    </mat-select>\n\n                                    </mat-form-field>\n                                </td>\n                                   </tr>\n                                   <tr>\n                                    <td>\n                                        <mat-form-field class=\"half-full-width\">\n                                            <mat-select placeholder=\"Choose Source of Repayment\">\n                                            <mat-option *ngFor=\" let repay of RepayMethods\" value={{repay.id}}>{{repay.repaydesc}}</mat-option>\n                                            </mat-select>\n                                            </mat-form-field>\n                                 </td>\n                                 <td class=\"td-space2\"></td>\n                                 <td>\n                                    <mat-form-field class=\"full-width\">\n                                        <mat-select placeholder=\"Choose Method of Repayment\">\n                                        <mat-option value=\"directdebit\">Direct Debit</mat-option>\n                                        <mat-option value=\"others\">Others</mat-option>\n\n                                        </mat-select>\n                                        </mat-form-field>\n                                    </td>\n                                  </tr>\n                                </table>\n<div class=\"w3-container w3-dark-grey\">\n<h5>Bank Details to Credit</h5>\n</div>\n<table style=\"width:90%\">\n<tr>\n<td>\n</td>\n<td class=\"td-space2\"></td>\n<td>\n<mat-form-field class=\"full-width\">\n    <input matInput placeholder=\"Bank Verification No.\">\n  </mat-form-field>\n</td>\n</tr>\n<tr>\n<td>\n<mat-form-field class=\"half-full-width\">\n    <mat-select placeholder=\"Select Bank\">\n    <mat-option value=\"Accessbank\">Access Bank Plc</mat-option>\n    <mat-option value=\"gtbank\">Guaranty Trust Bank Plc</mat-option>\n    <mat-option value=\"zenithbk\">Zenith Bank Plc</mat-option>\n    <mat-option value=\"1stbank\">First Bank Plc</mat-option>\n    </mat-select>\n    </mat-form-field>\n</td>\n<td class=\"td-space2\"></td>\n<td>\n<mat-form-field class=\"full-width\">\n    <input matInput placeholder=\"Account Number\">\n  </mat-form-field>\n</td>\n</tr>\n</table>\n</div>\n\n\n<!-- <div>\n<button mat-button matStepperPrevious>Back</button>\n<button mat-button matStepperNext>Next</button>\n</div> -->\n</mat-step>\n    <mat-step>\n      <!-- <ng-template matStepLabel> Guarantor and Attach Documents</ng-template> -->\n      <div class=\"main main-raised  w3-small\">\n        <h3>Guarantor </h3>\n\n        <table style=\"width:70%\">\n           <tr>\n           <td>\n           <mat-form-field class=\"half-full-width\">\n  <mat-select placeholder=\"Choose Title\">\n  <mat-option value=\"Mr\">Mr</mat-option>\n  <mat-option value=\"Mrs\">Mrs</mat-option>\n  <mat-option value=\"Miss\">Miss</mat-option>\n  <mat-option value=\"Chief\">Chief</mat-option>\n  <mat-option value=\"Prof\">Prof</mat-option>\n  <mat-option value=\"Pastor\">Pastor</mat-option>\n  <mat-option value=\"Alhaji\">Alhaji</mat-option>\n  <mat-option value=\"Alhaja\">Alhaja</mat-option>\n  </mat-select>\n  </mat-form-field>\n           </td>\n           <td class=\"td-space2\"></td>\n           <td>\n               <mat-form-field class=\"full-width\">\n               <input matInput placeholder=\"Surname\">\n             </mat-form-field>\n           </td>\n           </tr>\n           <tr>\n             <td>\n                 <mat-form-field class=\"full-width\">\n                     <input matInput placeholder=\"Other Name\">\n                   </mat-form-field>\n             </td>\n             <td class=\"td-space2\"></td>\n             <td>\n              <label class=\"w3-small w3-text-grey\" >Sex:</label>\n              <br>\n             <mat-radio-group  class=\"w3-small w3-text-grey\"  >\n             <mat-radio-button value=\"male\" >Male </mat-radio-button>\n             <mat-radio-button value=\"female\" >Female </mat-radio-button>\n             </mat-radio-group>\n             </td>\n             </tr>\n             <tr>\n                 <td>\n                    <mat-form-field class=\"half-full-width\">\n                        <input matInput placeholder=\"Telephone (Home)\">\n                      </mat-form-field>\n                </td>\n                <td class=\"td-space2\"></td>\n                    <td>\n                      <mat-form-field class=\"full-width\">\n                          <input matInput placeholder=\"Mobile No\">\n                        </mat-form-field>\n                 </td>\n                 </tr>\n\n                 <tr>\n                     <td>\n                        <mat-form-field class=\"full-width\">\n                            <input matInput placeholder=\"Residential Address (No P.O. Box)\">\n                          </mat-form-field>\n                     </td>\n                     </tr>\n                  <tr>\n                   <td>\n                      <mat-form-field class=\"half-full-width\">\n                          <mat-select placeholder=\"State\">\n                            <mat-option *ngFor=\" let lstate of nigeriastates\" value={{lstate.stateid}}>{{lstate.statename}}</mat-option>\n                          </mat-select>\n                          </mat-form-field>\n                   </td>\n                   <td class=\"td-space2\"></td>\n                   <td>\n                      <mat-form-field class=\"full-width\">\n                          <input matInput placeholder=\"City\">\n                        </mat-form-field>\n                   </td>\n\n                   </tr>\n           </table>\n\n           </div>\n    </mat-step>\n  </mat-horizontal-stepper>\n\n<table>\n    <tr>\n    <td>\n    <input type=\"button\" value=\"Loan\" class=\"w3-btn w3-round-large w3-border w3-border-red\" (click)=\"currentstep = 2\">\n    &nbsp;&nbsp;\n        <input type=\"button\" value=\" Employment and Next of Kin\" class=\"w3-btn w3-round-large w3-border w3-border-red\" (click)=\"currentstep = 1\">\n        &nbsp;&nbsp;\n      <input type=\"button\" value= \"Guarantor \" class=\"w3-btn w3-round-large w3-border w3-border-red\" (click)=\"currentstep = 3\">\n      &nbsp;&nbsp;\n</td>\n<td>\n   <input type=\"button\" value=\"Attached Document(s)\" class=\"w3-btn w3-round-large w3-border w3-border-red\">\n      </td>\n    </tr>\n    </table>\n    </div>\n  <div *ngIf=\"btnNewCustomerInfo==false\">\n<p>\n    <div class=\"main main-raised\">\n      <div  class=\"w3-container w3-blue\">\n      <h3>Customer Information</h3>\n      </div>\n      <br>\n      <br>\n      <table style=\"width:90%\">\n          <tr>\n              <button type=\"submit\" class=\"w3-btn w3-round-large w3-border w3-border-red\" (click)=\"btnNewCustomerInfo=true\"> New Customer </button>\n          </tr>\n\n      <tr>\n      <td>\n\n          <mat-form-field class=\"full-width\">\n            <mat-select placeholder=\"Select Search Parameter\">\n              <mat-option value=\"customerid\">Customer ID</mat-option>\n              <mat-option value=\"CustomerName\">Customer Name</mat-option>\n              <mat-option value=\"Employer\">Employer Name</mat-option>\n              <mat-option value=\"Guarantor\">Guarantor Name</mat-option>\n              <mat-option value=\"Nextofkin\">Next of Kin</mat-option>\n            </mat-select>\n            </mat-form-field>\n\n      </td>\n      <td class=\"td-space\"></td>\n                <td>\n          <mat-form-field class=\"full-width\">\n              <input matInput placeholder=\"Enter Your Search Parameter....\">\n               </mat-form-field>\n        </td>\n        <td class=\"td-space2\"></td>\n        <td>\n              <button mat-button type=\"submit\" class=\"w3-btn w3-round-large w3-border w3-border-red\">Search </button>\n\n        </td>\n      </tr>\n      </table>\n      </div>\n  </div>\n"
...
var CustomerinfoComponent = (function () {
    function CustomerinfoComponent(services) {
        this.services = services;
    ...
    CustomerinfoComponent.prototype.OnfileSelcted = function (event) {
        console.log(event);
        var file = event.target.files[0];
        alert(this.selectedfile.name);
    };
    CustomerinfoComponent.prototype.Onfileupload = function () {
        var fd = new FormData();
    };
    // return this.services.getloantypes().subscribe(lntypes => console.log(lntypes));
    CustomerinfoComponent.prototype.filtercity = function () {
        alert(this.customer.personalinfo.state);
    };
    CustomerinfoComponent.prototype.getcity = function () {
        var _this = this;
        return this.services.getstatecities().subscribe(function (ncities) { return _this.statecities = ncities; });
    };
    CustomerinfoComponent.prototype.getLoantypes = function () {
        var _this = this;
        return this.services.getloantypes().subscribe(function (lntypes) { return _this.loantypes = lntypes; });
    };
    CustomerinfoComponent.prototype.getStates = function () {
        var _this = this;
        return this.services.getstates().subscribe(function (nstates) { return _this.nigeriastates = nstates; });
    };
...
var FactypeComponent = (function () {
    ...
    FactypeComponent.prototype.frefresh = function () {
        ...
        this.getAllFacility(null);
    };
    FactypeComponent.prototype.deleteFacility = function (nFacilityID) {
        var _this = this;
        // return this.http.get(this.UserRoleUrl).subscribe(data => console.log(data));
        // this._mRole = JSON.stringify(nrole);
        if (confirm('Are you sure you want to delete this record?') === true) {
            this.NewFacility = 0;
            // tslint:disable-next-line:max-line-length
            return this.services.deleteFacility(nFacilityID).subscribe(function (resp) { return _this.getDeleteStatus(resp); }, function (error) { return _this.services.handleError(error); });
        }
    };
    FactypeComponent.prototype.getAllFacility = function (searchP) {
        ...
        if (searchP == null) {
            // tslint:disable-next-line:max-line-length
            return this.services.getFacility(searchP).subscribe(function (sfacility) { return _this.mFacilitylist = sfacility; }, function (error) { return _this.services.handleError(error); });
        }
        else {
            // tslint:disable-next-line:max-line-length
            return this.services.getFacility(searchP).subscribe(function (sfacility) { return _this.mFacilitylist = sfacility; }, function (error) { return _this.services.handleError(error); });
    ...
    FactypeComponent.prototype.AddNewFacility = function (ufacility) {
        ...
        if (this.btnNewFacility === true) {
            this.services.addNewFacility(ufacility).subscribe(function (resp) { return _this.getStatus(resp); }, function (error) { return _this.services.handleError(error); });
            this.NewFacility = 2;
            this.btnNewFacility = false;
        }
        else if (this.btnUpdate === true) {
            this.services.updateFacility(ufacility).subscribe(function (resp) { return _this.getStatus(resp); }, function (error) { return _this.services.handleError(error); });
    ...
    FactypeComponent.prototype.getDeleteStatus = function (numUpdate) {
        if (numUpdate === 1) {
            this.getAllFacility(null);
            alert('Operation Successful');
        }
        else {
            alert('Operation not successful at this time; Please Try Again Later');
        }
    };
...
var LoansliderComponent = (function () {
    ...
    LoansliderComponent.prototype.Repayment = function () {
        ...
        for (var t = 1; t <= this.lslider.month; t = t + 1) {
            ...
            this.totalrepayment = this.totalrepayment + this.compprincipal;
        }
        this.lslider.mnthrepay = this.monthrepay;
        this.lslider.totalrepay = this.totalrepayment;
...
var MyFilterPipe = (function () {
    ...
    MyFilterPipe.prototype.transform = function (statecities, selected) {
        if (selected === undefined) {
            return statecities;
        }
        return statecities.filter(function (city) {
            city.stateid.toLowerCase().includes(selected.stateid.toLowerCase());
        });
    };
...
var ServicesComponent = (function () {
    ...
    ServicesComponent.prototype.getPost = function (searchP) {
        ...
        // tslint:disable-next-line:one-line
        {
            ...
            return this.http.get(this.Url + 'UserRole');
        }
        else 
        // tslint:disable-next-line:one-line
        {
    ...
    ServicesComponent.prototype.deleteFacility = function (nFacilityID) {
        this.pUseroleURL = this.Url + 'facility/' + nFacilityID.facilityid;
        alert(this.pUseroleURL);
        return this.http.delete(this.pUseroleURL, nFacilityID);
    };
    ...
    ServicesComponent.prototype.updateRole = function (uRole) {
        return this.http.put(this.Url + 'UserRole/' + uRole.roleid, uRole);
    };
    ServicesComponent.prototype.deleteRole = function (uRole) {
        this.pUseroleURL = this.Url + 'UserRole/' + uRole.roleid;
        return this.http.delete(this.pUseroleURL, uRole);
    };
...
var UserroleComponent = (function () {
    ...
    UserroleComponent.prototype.getAllRoles = function (searchP) {
       ...
       this.mUserRole = this.services.mUserRole; */
        ...
        // tslint:disable-next-line:one-line
        {
            return this.services.getPost(searchP).subscribe(function (userrole) { return _this.mUserRole = userrole; }, function (error) { return _this.services.handleError(error); });
        }
        else 
        // tslint:disable-next-line:one-line
        {
    ...
    UserroleComponent.prototype.deleteRoles = function (nrole) {
        var _this = this;
        // return this.http.get(this.UserRoleUrl).subscribe(data => console.log(data));
        // this._mRole = JSON.stringify(nrole);
        if (confirm('Are you sure you want to delete this record?') === true) {
            this.Newrole = 0;
            return this.services.deleteRole(nrole).subscribe(function (resp) { return _this.getDeleteStatus(resp); }, function (error) { return _this.services.handleError(error); });
        }
    };
    ...
    UserroleComponent.prototype.addNewRoles = function (uRole) {
        var _this = this;
        ...
        if (this.btnNewrole === true) {
            // tslint:disable-next-line:max-line-length
            this.services.addNewRole(uRole).subscribe(function (resp) { _this.getStatus(resp); _this.nAdded = resp; }, function (error) { return _this.services.handleError(error); });
            this.Newrole = 2;
            this.btnNewrole = false;
        }
        else if (this.btnUpdate === true) {
            this._mRole = JSON.stringify(uRole);
            // tslint:disable-next-line:max-line-length
            this.services.updateRole(uRole).subscribe(function (resp) { _this.getStatus(resp); _this.nUpdate = resp; }, function (error) { return _this.services.handleError(error); });
            // this.services.updateRole( uRole ).subscribe(resp => console.log(resp));
    ...
    UserroleComponent.prototype.getDeleteStatus = function (numUpdate) {
        if (numUpdate === 1) {
            this.getAllRoles(null);
            alert('Operation Successful');
        }
